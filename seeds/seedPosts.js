...
const postData = [
    {
        ...
        body:"Data intelligence solutions are becoming increasingly important as businesses.",
        user_id: 1
    },
    {
        title:"Megaport Virtual Edge vs Equinix Network Edge: Compare top edge computing platforms",
        body:"As enterprises strive to scale network capacities to meet the evolving technological demands of digital transformation.",
        user_id:2
    },
    {
